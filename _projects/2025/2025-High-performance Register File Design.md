...
abstract: >-
  1) Designed a parallel register file (15W5R, 256×32 bit) with dual-cycle read and single-cycle write timing, implementing address pre-decoding and parallelized priority encoding strategies to reduce arbitration complexity for shortening the critical path.<br/>
